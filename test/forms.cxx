...
/
// This demo show the different boxtypes. Note that som
// boxtypes are not appropriate for some object
/
...
static int border = 1; // changed from FL_TRANSIENT for flt
...
static VN_struct btypes[]
   ...
   {Fl::box_index(FL_NO_BOX),"no box"}
   {Fl::box_index(FL_UP_BOX), "up box"}
   {Fl::box_index(FL_DOWN_BOX),"down box"}
   {Fl::box_index(FL_BORDER_BOX),"border box"}
   {Fl::box_index(FL_SHADOW_BOX),"shadow box"}
   {Fl::box_index(FL_FLAT_BOX),"flat box"}
   {Fl::box_index(FL_FRAME_BOX),"frame box"}
   {Fl::box_index(FL_EMBOSSED_BOX),"embossed box"}
   {Fl::box_index(FL_ROUNDED_BOX),"rounded box"}
   {Fl::box_index(FL_RFLAT_BOX),"rflat box"}
   {Fl::box_index(FL_RSHADOW_BOX),"rshadow box"}, // renamed for flt
   {Fl::box_index(FL_OVAL_BOX),"oval box"}
   {Fl::box_index(FL_ROUNDED3D_UPBOX),"rounded3d upbox"}
   {Fl::box_index(FL_ROUNDED3D_DOWNBOX),"rounded3d downbox"}
   {Fl::box_index(FL_OVAL3D_UPBOX),"oval3d upbox"}
   {Fl::box_index(FL_OVAL3D_DOWNBOX),"oval3d downbox"}
   {Fl::box_index(FL_PLASTIC_UP_BOX),"plastic upbox"}
   {Fl::box_index(FL_PLASTIC_DOWN_BOX),"plastic downbox"}
   /* sentinel *
   {-1
}
...
boxtype_cb (Fl_Widget * ob, long
  ...
  if(lastbt != req_bt
     ...
     lastbt = req_bt
     fl_redraw_form(form); // added for flt
...
//fl_set_object_dblbuffer(tobj[4],1); // removed for flt
...
//fl_set_object_dblbuffer(tobj[16], 1); // removed for flt
