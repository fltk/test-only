...
/
// Demonstrates how to use readqueue to see if a button has bee
// pushed, and to see if a window has been closed, thus avoidin
// the need to define callbacks
/
// This also demonstrates how to trap attempts by the user t
// close the last window by overriding Fl::exi
/
...
// this is a test to make sure automatic destructors work.  Pop u
