...
int main(int argc, char **argv) {
  ...
  o = new Fl_Item("Red"); o->type(Fl_Item::RADIO);
  o = new Fl_Item("Green"); o->type(Fl_Item::RADIO);
  o = new Fl_Item("Blue"); o->type(Fl_Item::RADIO);
  o = new Fl_Item("Aqua"); o->type(Fl_Item::RADIO);
  o = new Fl_Item("Toggle 1"); o->type(Fl_Item::TOGGLE);
  o = new Fl_Item("Toggle 2"); o->type(Fl_Item::TOGGLE);
  o = new Fl_Item("Toggle 3"); o->type(Fl_Item::TOGGLE);
  o = new Fl_Item("Toggle 4"); o->type(Fl_Item::TOGGLE);
  options.end();
