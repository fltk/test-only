//
// "$Id: scroll.cxx,v 1.13 2000/08/12 08:43:53 spitzak Exp $"
//
...
void box_cb(Fl_Widget* o, void*) {
  thescroll->text_box(o->value() ? (Fl_Boxtype)FL_DOWN_BOX : FL_NO_BOX);
  thescroll->relayout();
  thescroll->redraw();
}
...
//
// End of "$Id: scroll.cxx,v 1.13 2000/08/12 08:43:53 spitzak Exp $".
//
