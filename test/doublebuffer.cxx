...
/
// This demo shows how double buffering helps, by drawing th
// window in a particularily bad way
/
// The single-buffered window will blink as it updates.  Th
// double buffered one will not.  It will take just as lon
