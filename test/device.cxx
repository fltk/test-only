...
protected:
  void draw(){
    ...
    fltk3::rectf(7,7,w()-14,h()-14);
    fltk3::color(fltk3::BLUE);
    
    fltk3::rect(8,8,w()-16,h()-16);
    fltk3::push_clip(25,25,w()-50, h()-50);
    fltk3::color(fltk3::BLACK);
    fltk3::rect(24,24,w()-48,h()-48);
    fltk3::line(27,27,w()-27,h()-27);
    fltk3::line(27,h()-27,w()-27,27);
    //fltk3::rect(30,30,w()-60,h()-60);
    fltk3::pop_clip();
...
protected:
  void draw(){
    ...
    fltk3::push_clip(52,5,45,43);
    for(d=5;d<150;d+=3){
      fltk3::line(52,d,92,d-40);
    }
    fltk3::pop_clip();
    
    fltk3::line_style(fltk3::DASH);
    fltk3::xyline(5,55,48);
    fltk3::line_style(fltk3::DOT);
    fltk3::xyline(5,58,48);
    fltk3::line_style(fltk3::DASHDOT);
    fltk3::xyline(5,61,48);
    fltk3::line_style(fltk3::DASHDOTDOT);
    fltk3::xyline(5,64,48);
    fltk3::line_style(0,0,(char*)"\7\3\7\2");
    fltk3::xyline(5,67,48);
    
    fltk3::line_style(0);
    
    fltk3::line(5,72,25,95);
    fltk3::line(8,72,28,95,31,72);
    
    fltk3::color(fltk3::YELLOW);
    fltk3::polygon(11, 72,27,91,29,72);
    fltk3::color(fltk3::RED);
    fltk3::loop(11, 72,27,91,29,72);
    
    fltk3::color(fltk3::BLUE); ////
    fltk3::line_style(fltk3::SOLID, 6);
    fltk3::loop(31, 12,47,31,49,12);
    fltk3::line_style(0);
    
    fltk3::color(200,0,200);
    fltk3::polygon(35,72,33,95,48,95,43,72);
    fltk3::color(fltk3::GREEN);
    fltk3::loop(35,72,33,95,48,95,43,72);
    
    fltk3::color(fltk3::BLUE);    
    fltk3::yxline(65,63,66);
    fltk3::color(fltk3::GREEN);    
    fltk3::yxline(66,66,63);
    
    fltk3::color(fltk3::BLUE);
    fltk3::rect(80,55,5,5);
    fltk3::color(fltk3::YELLOW);
    fltk3::rectf(81,56,3,3);
    fltk3::color(fltk3::BLACK);
    fltk3::point(82,57);
    
    fltk3::color(fltk3::BLUE);
    fltk3::rect(56, 79, 24, 17);
    fltk3::color(fltk3::CYAN);
    fltk3::rectf(57, 80, 22 , 15 );
    fltk3::color(fltk3::RED);
    fltk3::arc(57, 80, 22 ,15 ,40, 270);
    fltk3::color(fltk3::YELLOW);
    fltk3::pie(58, 81, 20 ,13 ,40, 270);
    ...
    fltk3::point(58,58);
    fltk3::color(fltk3::RED);
    fltk3::yxline(59,58,59);
    fltk3::color(fltk3::GREEN);
    fltk3::yxline(60,59,58);
    fltk3::color(fltk3::BLACK);
    fltk3::xyline(61,58,62);
    fltk3::color(fltk3::RED);
    fltk3::xyline(62,59,61);
    
    fltk3::color(fltk3::GREEN);
    fltk3::yxline(57,58,59,58);
    fltk3::color(fltk3::BLUE);
    fltk3::xyline(58,60,56,58);
    fltk3::color(fltk3::RED);
    fltk3::xyline(58,61,56,63);
    fltk3::color(fltk3::GREEN);
    fltk3::yxline(57,63,62,58);
    
    fltk3::color(fltk3::BLUE);
    fltk3::line(58,63, 60, 65);
    fltk3::color(fltk3::BLACK);
    fltk3::line(61,65, 59, 63);
...
protected:
  void draw(){
    ...
    fltk3::push_clip(52,5,45,43);
    for(d=5;d<150;d+=2.3052){
      fltk3::begin_line();
      fltk3::vertex(52,d);
      fltk3::vertex(92,d-43);
      fltk3::end_line();
    }
    fltk3::pop_clip();
...
protected:
  void draw(){
    ...
    fltk3::line_style(fltk3::SOLID,5);
    fltk3::line(15,10,w()-15,h()-23);
    fltk3::line(w()-15,10,15,h()-23);
    fltk3::line_style(0);
    draw_label();
  };
public:
