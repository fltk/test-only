...
// Known bugs
/
// X insists on reporting the state *before* the shift key wa
// pressed, rather than after, on shift key events.  I fixed this fo
...
// lock, and alt.  They may also not agree about the symbols for the extr
...
int handle(int e) 
  return (e == FL_SHORTCUT); // eat all keystroke
