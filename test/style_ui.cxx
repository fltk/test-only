...
Fl_Menu_Item menu_[] = {
 ...
 {"New", 0,  0, 0, 0, 0, 0, 14, 0},
 {"&Open", 0x8006f,  (Fl_Callback*)cb_Open, 0, 0, 0, 0, 14, 0},
 {"&Save", 0,  0, 0, 0, 0, 0, 14, 0},
 {"Save as...", 0,  0, 0, 0, 0, 0, 14, 0},
 {"Duplicate", 0,  0, 0, 0, 0, 0, 14, 0},
 {"&Quit", 0x80071,  (Fl_Callback*)cb_Quit, 0, 0, 0, 0, 14, 0},
 {0},
 {"&Edit", 0,  0, 0, 64, 0, 0, 14, 0},
 {"Cut", 0,  0, 0, 0, 0, 0, 14, 0},
 {"Copy", 0,  0, 0, 0, 0, 0, 14, 0},
 {"Paste", 0,  0, 0, 0, 0, 0, 14, 0},
 {"Undo", 0,  0, 0, 128, 0, 0, 14, 0},
 {"Move", 0,  0, 0, 0, 0, 0, 14, 0},
 {"Constrain", 0,  0, 0, 0, 0, 0, 14, 0},
 {"Arbitrate", 0,  0, 0, 0, 0, 0, 14, 0},
 {0},
 {"Options", 0,  0, 0, 64, 0, 0, 14, 0},
 {"Red", 0,  0, 0, 2, 0, 0, 14, 0},
 {"Blue", 0,  0, 0, 2, 0, 0, 14, 0},
 {"Green", 0,  0, 0, 2, 0, 0, 14, 0},
 {"Yellow", 0,  0, 0, 2, 0, 0, 14, 0},
 {"Fast", 0,  0, 0, 8, 0, 0, 14, 0},
 {"Good", 0,  0, 0, 8, 0, 0, 14, 0},
 {"Cheap", 0,  0, 0, 8, 0, 0, 14, 0},
 {0},
 {"Themes", 0,  0, 0, 64, 0, 0, 14, 0},
 {"Windoze", 0,  (Fl_Callback*)cb_Windoze, 0, 12, 0, 0, 14, 0},
 {"Motif", 0,  (Fl_Callback*)cb_Motif, 0, 8, 0, 0, 14, 0},
 {"Fltk classic", 0,  (Fl_Callback*)cb_Fltk, 0, 8, 0, 0, 14, 0},
 {0},
 {0}
};
...
Fl_Window* make_window() {
  ...
  { Fl_Window* o = new Fl_Window(534, 406);
    ...
    { Fl_Check_Button* o = new Fl_Check_Button(390, 35, 85, 25, "check1");
      o->down_box(FL_DIAMOND_DOWN_BOX);
    }
    { Fl_Check_Button* o = new Fl_Check_Button(390, 60, 85, 25, "check1");
      o->down_box(FL_DIAMOND_DOWN_BOX);
    }
    { Fl_Check_Button* o = new Fl_Check_Button(390, 85, 85, 25, "check1");
      o->down_box(FL_DIAMOND_DOWN_BOX);
    }
    { Fl_Check_Button* o = new Fl_Check_Button(390, 110, 85, 25, "check1");
      o->down_box(FL_DIAMOND_DOWN_BOX);
    }
