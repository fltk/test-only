...
// It has been modified as little as possible to work under fltk b
// using fltk's Forms emulation.  Search for "fltk" to find all th
// change
/
...
#include <FL/forms.H>	// changed for flt
#include <stdlib.h
#include <stdio.h>	// added for flt
#include <string.h>	// added for flt
...
//    fl_set_form_minsize(cl, cl->w , cl->h); // removed for flt
//    fl_set_form_maxsize(cl, 2*cl->w , 2*cl->h); // removed for flt
    cl->size_range(cl->w(),cl->h(),2*cl->w(),2*cl->h()); // added for flt
