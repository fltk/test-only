...
// on each of them
/
// This program requires either the libjpeg.a library or an internal D
// library to read images (this is chosen by the presence of the "DD
// #define)
/
// To get the jpeg library
/
// The "official" archive site for this software is ftp.uu.net (Interne
// address 192.48.96.9).  The most recent released version can always b
// found there in directory graphics/jpeg.  This particular version wil
// be archived as graphics/jpeg/jpegsrc.v6a.tar.gz
/
// The makefile assummes you decompressed and build these in a director
...
void readtheimage(const char *name); // belo
int width
int height
int depth
int linedelta
...
"%s\n"
  ...
  if (visid>=0) 
    ...
    fl_xpixel(0); // make sure black is allocate
...
///////////////////////////////////////////////////////////////
#else // Digital Domain in-house librar
