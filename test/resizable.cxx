...
s resizable to nest different resize behavior.");
      { Fl_Button* o = new Fl_Button(5, 230, 85, 25, "You can put");
        o->color((Fl_Color)47);
      }
      { Fl_Button* o = new Fl_Button(5, 255, 85, 25, "them inside");
        o->color((Fl_Color)47);
      }
      { Fl_Button* o = new Fl_Button(5, 280, 85, 25, "a group to");
        o->color((Fl_Color)47);
      }
      { Fl_Button* o = new Fl_Button(5, 305, 85, 25, "stop scaling.");
        o->color((Fl_Color)47);
      }
      o->end();
    }
