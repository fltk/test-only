...
/
// Notice that Fl_Image is for a static, multiple-reuse image, suc
// as an icon or postage stamp.  Use fl_draw_image to go directl
...
int main(int argc, char **argv) 
  ...
  if (visid >= 0) 
    ...
    fl_xpixel(FL_BLACK); // make sure black is allocated in overlay visual
  } else 
    Fl::visual(FL_RGB)
