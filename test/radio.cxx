...
Fl_Light_Button *ttlb=(Fl_Light_Button *)0;
...
int main(int argc, char **argv) {
  ...
  { Fl_Window* o = new Fl_Window(380, 274, "Radio buttons and Tooltips");
    ...
    { Fl_Button* o = new Fl_Button(20, 10, 160, 30, "Fl_Button");
      o->tooltip("This is a button");
    }
    { Fl_Return_Button* o = new Fl_Return_Button(20, 50, 160, 30, "Fl_Return_Button");
      o->shortcut(0xff0d);
      o->tooltip("This is a return button");
    }
    { Fl_Light_Button* o = new Fl_Light_Button(20, 90, 160, 30, "Fl_Light_Button");
...
multiple lines.");
    ...
    { Fl_Group* o = new Fl_Group(190, 10, 70, 120);
      ...
      { Fl_Check_Button* o = new Fl_Check_Button(0, 0, 70, 30, "radio");
        o->type(102);
        o->tooltip("This is a check button");
      }
      { Fl_Check_Button* o = new Fl_Check_Button(0, 30, 70, 30, "radio");
        o->type(102);
        o->tooltip("This is a check button");
      }
      { Fl_Check_Button* o = new Fl_Check_Button(0, 60, 70, 30, "radio");
        o->type(102);
        o->tooltip("This is a check button");
      }
      { Fl_Check_Button* o = new Fl_Check_Button(0, 90, 70, 30, "radio");
        o->type(102);
        o->tooltip("This is a check button");
      }
      o->end();
    ...
    { Fl_Group* o = new Fl_Group(270, 10, 90, 115);
      ...
      o->tooltip("This is a group");
      { Fl_Button* o = new Fl_Button(10, 10, 20, 20, "radio");
        o->type(102);
        o->align(FL_ALIGN_RIGHT);
        o->tooltip("This the first button of the group");
      }
      { Fl_Button* o = new Fl_Button(10, 35, 20, 20, "radio");
        o->type(102);
        o->align(FL_ALIGN_RIGHT);
        o->tooltip("This the second button of the group");
      }
      { Fl_Button* o = new Fl_Button(10, 60, 20, 20, "radio");
        o->type(102);
        o->align(FL_ALIGN_RIGHT);
        o->tooltip("This the third button of the group");
      }
      { Fl_Button* o = new Fl_Button(10, 85, 20, 20, "radio");
        o->type(102);
        o->align(FL_ALIGN_RIGHT);
