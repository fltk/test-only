...
int main(int argc, char **argv) {
  ...
  { Fl_Window* o = new Fl_Window(329, 240, 420, 295);
    ...
    { Fl_Group* o = the_group = new Fl_Group(25, 25, 375, 235, "activate()/deactivate() called on this Fl_Group");
      ...
      { Fl_Input* o = new Fl_Input(170, 25, 195, 30);
        o->static_value("Fl_Input");
      }
      { Fl_Input_Browser* o = new Fl_Input_Browser(255, 80, 110, 30, "input browser"); o->begin();
        new Fl_Item("Moe");
        new Fl_Item("Larry");
        new Fl_Item("Curly");
        o->value("Shemp");
