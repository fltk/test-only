...
public:
  ...
  Image(const char* name=0) : 
      Symbol(name), picture(0), flags(0), w_(-1), h_(-1),p_(UNDEFINED),ld_(0),count_(0), data_(0)  {}
  Image(int w, int h, const char* name=0, const char * const * d=0) :
    Symbol(name), picture(0), flags(0), w_(w), h_(h), p_(UNDEFINED),ld_(0),count_(0),data_(d) {}
