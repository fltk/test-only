//
// "$Id: Fl_Int_Input.h,v 1.1 2001/07/23 09:50:04 spitzak Exp $"
//
...
public:
  Fl_Int_Input(int x,int y,int w,int h,const char *l = 0)
    : Fl_Float_Input(x,y,w,h,l) {type(FL_INT_INPUT);}
};

#endif

//
// End of "$Id: Fl_Int_Input.h,v 1.1 2001/07/23 09:50:04 spitzak Exp $".
//
