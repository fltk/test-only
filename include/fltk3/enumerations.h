...
namespace fltk3 {
  ...
  extern FLTK3_EXPORT Box* CLASSIC_UP_BOX;
  extern FLTK3_EXPORT Box* CLASSIC_DOWN_BOX;
  extern FLTK3_EXPORT Box* CLASSIC_UP_FRAME;
  extern FLTK3_EXPORT Box* CLASSIC_DOWN_FRAME;
  extern FLTK3_EXPORT Box* CLASSIC_THIN_UP_BOX;
  extern FLTK3_EXPORT Box* CLASSIC_THIN_DOWN_BOX;
  extern FLTK3_EXPORT Box* CLASSIC_THIN_UP_FRAME;
  extern FLTK3_EXPORT Box* CLASSIC_THIN_DOWN_FRAME;
  extern FLTK3_EXPORT Box* CLASSIC_ROUND_UP_BOX;
  extern FLTK3_EXPORT Box* CLASSIC_ROUND_DOWN_BOX;
