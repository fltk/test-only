...
namespace fltk3 {
  ...
  public:
     ...
     */
    const fltk3::TextSelection* primary_selection() const { return &mPrimary; }
    
    /**
     Returns the primary selection. 
     */
    fltk3::TextSelection* primary_selection() { return &mPrimary; }
    
    /**
     Returns the secondary selection.
     */
    const fltk3::TextSelection* secondary_selection() const { return &mSecondary; }
    
    /**
     Returns the current highlight selection.
     */
    const fltk3::TextSelection* highlight_selection() const { return &mHighlight; }
