//
// "$Id: NiceSlider.h 8022 2010-12-12 23:21:03Z AlbrechtS $"
//
...
public:
	...
	: Fl_Slider(x,y,w,h,l) {type(fltk3::VERT_NICE_SLIDER); box(fltk3::FLAT_BOX);}
};

#endif

//
// End of "$Id: NiceSlider.h 8022 2010-12-12 23:21:03Z AlbrechtS $".
//
