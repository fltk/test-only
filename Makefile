#
# "$Id: Makefile,v 1.12.2.6.2.14.2.2 2003/11/11 04:13:25 easysw Exp $"
#
...
DIRS	=	$(BUILDXUTF8) src fluid test documentation
...
#
# End of "$Id: Makefile,v 1.12.2.6.2.14.2.2 2003/11/11 04:13:25 easysw Exp $".
#
