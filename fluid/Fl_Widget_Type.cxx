//
// "$Id: Fl_Widget_Type.cxx,v 1.90 2002/12/09 04:52:22 spitzak Exp $"
//
...
void WidgetType::read_property(const char *c) {
  ...
  } else if (!strcmp(c,"highlight_labelcolor") ||
	     !strcmp(c,"highlight_label_color")) {
    o->highlight_labelcolor((fltk::Color)strtoul(read_word(),0,0));
...
//
// End of "$Id: Fl_Widget_Type.cxx,v 1.90 2002/12/09 04:52:22 spitzak Exp $".
//
