...
fltk3::Group *pFileNameGroup=(fltk3::Group *)0;

static void cb_pFileNameGroup(fltk3::Group* o, void* v) {
  if (v == Fl_Panel::LOAD) {
  for (Fl_Type *t = Fl_Type::first; t; t = t->next) {
    if (t->selected && t->is_file()) {
      o->show();
...
fltk3::Input *pFileName=(fltk3::Input *)0;

static void cb_pFileName(fltk3::Input* o, void* v) {
  if (v == Fl_Panel::LOAD) {
  ...
  { Fl_Panel* o = new Fl_Panel(0, 0, 420, 450, "File Properties");
    ...
    { pScrollGroup = new fltk3::ScrollGroup(10, 10, 400, 400);
      ...
      { fltk3::PackedGroup* o = new fltk3::PackedGroup(0, 0, 400, 400);
        ...
        { pFileNameGroup = new fltk3::Group(0, 89, 400, 30);
          pFileNameGroup->labelsize(12);
          pFileNameGroup->callback((fltk3::Callback*)cb_pFileNameGroup);
          pFileNameGroup->align(fltk3::Align(fltk3::ALIGN_LEFT));
          { pFileName = new fltk3::Input(100, 5, 250, 20, "File Name ");
            pFileName->tooltip("name and path of the file");
            pFileName->labelsize(12);
            pFileName->textsize(12);
            pFileName->callback((fltk3::Callback*)cb_pFileName);
            pFileName->when(fltk3::WHEN_CHANGED);
            fltk3::Group::current()->resizable(pFileName);
          } // fltk3::Input* pFileName
          { fltk3::Button* o = new fltk3::Button(350, 5, 40, 20, "@-3filenew");
            o->color(fltk3::LIGHT2);
            o->labelcolor((fltk3::Color)43);
            o->callback((fltk3::Callback*)cb_3filenew);
