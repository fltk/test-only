...
fltk::CodeEditor *code_input=(fltk::CodeEditor *)0;
...
fltk::Window* make_code_panel() {
  fltk::Window* w;
   {fltk::Window* o = code_panel = new fltk::Window(290, 175, "code");
    ...
    o->begin();
     {fltk::CodeEditor* o = code_input = new fltk::CodeEditor(6, 5, 280, 138);
      o->type(4);
...
fltk::CodeViewer *sv_source=(fltk::CodeViewer *)0;

fltk::CodeViewer *sv_header=(fltk::CodeViewer *)0;
  ...
  fltk::DoubleBufferWindow* w;
   {fltk::DoubleBufferWindow* o = sourceview_panel = new fltk::DoubleBufferWindow(520, 490, "Code View");
    ...
    o->begin();
     {fltk::TabGroup* o = sv_tab = new fltk::TabGroup(10, 10, 500, 440);
      ...
      o->begin();
       {fltk::Group* o = new fltk::Group(0, 25, 500, 415, "Source");
        ...
        o->hide();
        o->begin();
         {fltk::CodeViewer* o = sv_source = new fltk::CodeViewer(10, 15, 480, 390);
       ...
       {fltk::Group* o = new fltk::Group(0, 25, 500, 415, "Header");
        o->labelsize(13);
        o->begin();
         {fltk::CodeViewer* o = sv_header = new fltk::CodeViewer(10, 15, 480, 390);
          o->textfont(fltk::COURIER);
          o->textsize(11);
          fltk::Group::current()->resizable(o);
        }
     ...
     {fltk::Group* o = new fltk::Group(10, 460, 500, 20);
      o->begin();
