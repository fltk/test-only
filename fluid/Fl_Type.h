//
// "$Id: Fl_Type.h,v 1.17 1999/10/03 06:31:35 bill Exp $"
//
...
void write_carray(const char *);
void write_carray(const char *,int length);
...
//
// End of "$Id: Fl_Type.h,v 1.17 1999/10/03 06:31:35 bill Exp $".
//
