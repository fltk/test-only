...
static void cb_recent_spinner(fltk::ValueInput*, void*) {
  prefs.recent_files((int) recent_spinner->value());
  load_history();
}
       ...
       {fltk::Group* o = new fltk::Group(0, 30, 360, 180, "General");
        ...
        o->begin();
         {fltk::CheckButton* o = openlast_button = new fltk::CheckButton(10, 0, 193, 25, "Open Previous File on Startup");
          ...
          int b;
          prefs.get("open_previous_file", b, 0);
         ...
         {fltk::CheckButton* o = completion_button = new fltk::CheckButton(10, 50, 186, 25, "Show Completion Dialog Info");
          ...
          int b;
          prefs.get("show_completion_dialogs", b, 1);
   ...
   {fltk::DoubleBufferWindow* o = shell_window = new fltk::DoubleBufferWindow(365, 125, "Shell Command");
    ...
    o->begin();
     {fltk::Input* o = shell_command_input = new fltk::Input(10, 27, 347, 25, "Command:");
      ...
      o->align(fltk::ALIGN_TOP|fltk::ALIGN_LEFT);
      char buf[1024];
      prefs.get("shell_command", buf, "", sizeof(buf));
