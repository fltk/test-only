...
fltk::Group *gImage=(fltk::Group *)0;
...
it should be left off if label will fit");
         ...
         {fltk::Group* o = gImage = new fltk::Group(10, 70, 359, 62);
          ...
          o->begin();
           ...
           {fltk::Button* o = image_button1 = new fltk::Button(74, 0, 285, 16);
           ...
           {fltk::Widget* o = image_label2 = new fltk::Widget(0, 15, 73, 17, "inactive");
            o->box(fltk::NO_BOX);
            o->align(fltk::ALIGN_RIGHT|fltk::ALIGN_CENTER|fltk::ALIGN_INSIDE);
          }
           {fltk::Button* o = image_button2 = new fltk::Button(74, 15, 285, 16);
            o->color((fltk::Color)7);
            o->callback((fltk::Callback*)image_cb, (void*)(2));
            o->align(fltk::ALIGN_LEFT|fltk::ALIGN_CENTER|fltk::ALIGN_INSIDE);
            ((fltk::Window*)(o->parent()->parent()->parent()->parent()))->hotspot(o);
            o->tooltip("Select an image to label the widget");
          }
           {fltk::Widget* o = image_label3 = new fltk::Widget(0, 30, 73, 17, "mouse on");
            o->box(fltk::NO_BOX);
            o->align(fltk::ALIGN_RIGHT|fltk::ALIGN_CENTER|fltk::ALIGN_INSIDE);
          }
           {fltk::Button* o = image_button3 = new fltk::Button(74, 30, 285, 16);
            o->color((fltk::Color)7);
            o->callback((fltk::Callback*)image_cb, (void*)(3));
            o->align(fltk::ALIGN_LEFT|fltk::ALIGN_CENTER|fltk::ALIGN_INSIDE);
            o->tooltip("Select an image to label the widget");
          }
           {fltk::Widget* o = image_label4 = new fltk::Widget(0, 45, 73, 17, "pushed");
            o->box(fltk::NO_BOX);
            o->align(fltk::ALIGN_RIGHT|fltk::ALIGN_CENTER|fltk::ALIGN_INSIDE);
          }
           {fltk::Button* o = image_button4 = new fltk::Button(74, 45, 285, 16);
            o->color((fltk::Color)7);
...
rtcut-setting mode:\n   Click the mouse on this again, or on some other field.");
           ...
           {fltk::WordwrapInput* o = new fltk::WordwrapInput(55, 25, 290, 34, "Tooltip");
            o->type(5);
