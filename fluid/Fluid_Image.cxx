//
// "$Id: Fluid_Image.cxx,v 1.20 2001/03/08 23:49:29 robertk Exp $"
//
...
void generic_image::write_static() {
  ...
  if (inlined) {
    size_t l=0;
    goto_images_dir();
    if (filetype->name && !strcmp(filetype->name, "XPM")) {
...
//
// End of "$Id: Fluid_Image.cxx,v 1.20 2001/03/08 23:49:29 robertk Exp $".
//
