...
# ADD LINK32 fltkdll.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"libcd" /out:"../fluid/fluid.exe" /libpath:"..\lib" /ref:"../lib/fluidd.ref" /lib:"../lib/fluidd.lib"
...
# ADD CPP /nologo /MTd /Gm /GX /ZI /Od /I ".." /I "../visualc" /D "FL_DLL" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "WIN32_LEAN_AND_MEAN" /D "VC_EXTRA_LEAN" /D "WIN32_EXTRA_LEAN" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 fltkdlld.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /incremental:no /debug /machine:I386 /nodefaultlib:"libcd" /out:"../fluid/fluidd.exe" /implib:"../lib/fluidd.lib" /pdbtype:sept /libpath:"..\lib"
# SUBTRACT LINK32 /pdb:none
