...
// Return an overlay visual, if any.  Also allocate a colormap an
// record the depth for fl_color() to use
// Another disgusting X interface, based on code extracted an
...
XVisualInfo *fl_find_overlay_visual() 
  ...
  if (actualType == overlayVisualsAtom && actualFormat == 32) 
    ...
    for (int i = 0; i < n; i++) 
      ...
      if (v1->screen == fl_screen && v1->c_class == PseudoColo
