...
inline void Fl_FileChooser::cb_okButton_i(Fl_Button*, void*) {
  window->hide();
}
void Fl_FileChooser::cb_okButton(Fl_Button* o, void* v) {
...
Fl_FileChooser::Fl_FileChooser(const char *d, const char *p, int t, const char *title) {
  ...
  { Fl_Window* o = window = new Fl_Window(375, 315, "Pick a File");
    ...
    { Fl_Button* o = okButton = new Fl_Button(250, 280, 45, 25, "OK");
