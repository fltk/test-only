//
// "$Id: fl_oval_box.cxx,v 1.8 1999/11/01 02:21:39 carl Exp $"
//
...
const Fl_Boxtype_ fl_oval_shadow_box = {
  oval_shadow_draw, 0, 0, 0, 1,1,2+3,2+3,
};

//
// End of "$Id: fl_oval_box.cxx,v 1.8 1999/11/01 02:21:39 carl Exp $".
//
