//
// "$Id: Fl_Item.cxx,v 1.9 2000/09/27 16:25:51 spitzak Exp $"
//
...
Fl_Menu_::Fl_Menu_(const char* l) : Fl_Group(0,0,0,0,l), list_(&default_list) {
  style(::style);
  align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  item_ = 0;
  // end()?
