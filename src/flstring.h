...
#  include <stdarg.h>
#  include <string.h>
#  if !defined(_WIN32) && defined(HAVE_STRINGS_H)
#    include <strings.h>
...
FL_API extern int fl_snprintf(char *, size_t, const char *, ...);
#  if !HAVE_SNPRINTF
#    define snprintf fl_snprintf
#  endif /* !HAVE_SNPRINTF */

FL_API extern int fl_vsnprintf(char *, size_t, const char *, va_list ap);
#  if !HAVE_VSNPRINTF
...
FL_API extern size_t fl_strlcat(char *, const char *, size_t);
#  if !HAVE_STRLCAT
#    define strlcat fl_strlcat
#  endif /* !HAVE_STRLCAT */

FL_API extern size_t fl_strlcpy(char *, const char *, size_t);
#  if !HAVE_STRLCPY
