//
// "$Id: fl_motif.cxx,v 1.1 1999/11/08 22:21:57 carl Exp $"
//
...
static const Fl_Boxtype_ thick_motif_down_box = {
  fl_frame, "JJVVJJVVJJVV", &thick_motif_down_box, &thick_motif_down_box, 3,3,6,6, true
};

static const Fl_Boxtype_ thick_motif_up_box = {
  fl_frame, "VVJJVVJJVVJJ", &thick_motif_up_box, &thick_motif_up_box, 3,3,6,6, true
};

static const Fl_Boxtype_ thick_motif_box = {
  fl_frame, "VVJJVVJJVVJJ", &thick_motif_down_box, &thick_motif_box, 3,3,6,6, true
};

static const Fl_Boxtype_ thin_motif_down_box = {
  fl_frame, "JJVVJJVV", &thin_motif_down_box, &thin_motif_down_box, 2,2,4,4, true
};

static const Fl_Boxtype_ thin_motif_up_box = {
  fl_frame, "VVJJVVJJ", &thin_motif_up_box, &thin_motif_up_box, 2,2,4,4, true
};

static const Fl_Boxtype_ thin_motif_box = {
  fl_frame, "VVJJVVJJ", &thin_motif_down_box, &thin_motif_box, 2,2,4,4, true
};
                ...
                Fl_Flags f, Fl_Boxtype box)
{
  switch (t) {
    ...
    case FL_GLYPH_RADIO: {
      ...
      int x1 = x+w/2;
      int y1 = y+h/2;
      Fl_Color light = 53, dark = 41;
      if (f&FL_VALUE) { light = 41; dark = 53; }
      ...
      fl_color(light); fl_line(x, y1, x1, y, x+w, y1);
      fl_color(light); fl_line(x+1, y1, x1, y+1, x+w-1, y1);
      fl_color(light); fl_line(x+2, y1, x1, y+2, x+w-2, y1);

      fl_color(dark); fl_line(x, y1, x1, y+h, x+w, y1);
      fl_color(dark); fl_line(x+1, y1, x1, y+h-1, x+w-1, y1);
      fl_color(dark); fl_line(x+2, y1, x1, y+h-2, x+w-2, y1);
      break;
    }
    case FL_GLYPH_CHECK:
      if (box != FL_NO_BOX) { x += 3; y += 3; w -= 6; h -= 6; } // non-menu fudge factor
    ...
    case FL_GLYPH_DOWN: {
      ...
      if (f&FL_VALUE) {
        d1 = 53; d2 = 53; l1 = 41; l2 = 41;
      } else{
        l1 = 53; l2 = 53; d1 = 41; d2 = 41;
      }
...
int fl_motif() {
  ...
  fl_popup_box = &thin_motif_up_box;

  fl_normal_box.data = "VVJJVVJJ";
  fl_normal_box.dx_ = 2;
  fl_normal_box.dy_ = 2;
  fl_normal_box.dw_ = 4;
  fl_normal_box.dh_ = 4;
  fl_up_box.data = "VVJJVVJJ";
  fl_up_box.dx_ = 2;
  fl_up_box.dy_ = 2;
  fl_up_box.dw_ = 4;
  fl_up_box.dh_ = 4;
  fl_down_box.data = "JJVVJJVV";
  fl_down_box.dx_ = 2;
  fl_down_box.dy_ = 2;
  fl_down_box.dw_ = 4;
  fl_down_box.dh_ = 4;
  ...
  Fl_Widget::default_style.set_selection_color(FL_DARK2);
...
//
// End of "$Id: fl_motif.cxx,v 1.1 1999/11/08 22:21:57 carl Exp $".
//
