...
// Besides being a useful object on it's own, the Fl_Color_Chooser wa
// an attempt to make a complex composite object that could be easil
// imbedded into a user interface.  If you wish to make complex object
// of your own, be sure to read this code

// The function fl_color_chooser() creates a window containing a colo
// chooser and a few buttons and current-color indicators.  It is a
...
#define CIRCLE 
// And the "hue box" can auto-update when the value change
// you get this by defining this
#define UPDATE_HUE_BOX 
...
enum {M_RGB, M_BYTE, M_HEX, M_HSV}; // mode
