//
// "$Id: Fl_Scroll.cxx,v 1.29 2001/03/08 07:39:05 clip Exp $"
//
...
int Fl_Scroll::handle(int event) {
 ...
 case FL_VIEWCHANGE:
  ...
  if (event == FL_SHORTCUT) {
    if (scrollbar.takesevents() && scrollbar.handle(FL_KEYBOARD)) return 1;
    if (hscrollbar.takesevents() && hscrollbar.handle(FL_KEYBOARD)) return 1;
  }
  return 0;
}

//
// End of "$Id: Fl_Scroll.cxx,v 1.29 2001/03/08 07:39:05 clip Exp $".
//
