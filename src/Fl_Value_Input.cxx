//
// "$Id: Fl_Value_Input.cxx,v 1.13 1999/06/15 17:02:31 gustavo Exp $"
//
...
void Fl_Value_Input::layout() {
  Fl_Valuator::layout();
  input.resize(x(),y(),w(),h());input.layout();
}
...
//
// End of "$Id: Fl_Value_Input.cxx,v 1.13 1999/06/15 17:02:31 gustavo Exp $".
//
