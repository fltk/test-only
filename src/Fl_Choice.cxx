...
// Emulates the Forms choice widget.  This is almost exactly the sam
// as an Fl_Menu_Button.  The only difference is the appearance of th
...
void Fl_Choice::draw() 
  ...
  if (mvalue()) 
    ...
    if ( Fl::scheme()) 
      ...
      fl_draw_shortcut = 2; // hack value to make '&' disappea
