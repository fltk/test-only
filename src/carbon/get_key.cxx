...
// which are actually X keysyms.  So this has to translate to macO
// symbols
...
// See also the inverse converter in Fl_mac.cx
...
//: returns true, if that key was pressed during the last even
...
//: returns true, if that key is pressed right no
int Fl::get_key(int k) 
  KeyMap foo
  GetKeys(foo)
#ifdef MAC_TEST_FOR_KEYCODE
 static int cnt = 0
 if (cnt++>1024) 
  cnt = 0
