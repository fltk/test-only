...
Fl_Shared_Image **Fl_Shared_Image::images_ = 0;	// Shared image
int	Fl_Shared_Image::num_images_ = 0;	// Number of shared image
int	Fl_Shared_Image::alloc_images_ = 0;	// Allocated shared image

Fl_Shared_Handler *Fl_Shared_Image::handlers_;	// Additional format handler
int	Fl_Shared_Image::num_handlers_;		// Number of format handler
int	Fl_Shared_Image::alloc_handlers_;	// Allocated format handler
...
// Static methods that really should be inline, but some WIN32 compiler
// can't handle it..
...
in
Fl_Shared_Image::compare(Fl_Shared_Image **i0,		// I - First imag
                         Fl_Shared_Image **i1) {	// I - Second imag
...
Fl_Shared_Image::Fl_Shared_Image(const char *n,		// I - Filenam
                                 Fl_Image   *img)	// I - Imag
  : Fl_Image(0,0,0) 
...
Fl_Shared_Image::reload() 
  ...
  int		i;		// Looping va
  FILE		*fp;		// File pointe
  uchar		header[64];	// Buffer for auto-detecting file
  Fl_Image	*img;		// New imag
  ...
  if (memcmp(header, "#define", 7) == 0) // XBM fil
    img = new Fl_XBM_Image(name_)
  else if (memcmp(header, "/* XPM */", 9) == 0) // XPM fil
...
Fl_Shared_Image::copy(int W, int H) 
  Fl_Image		*temp_image;	// New image fil
  Fl_Shared_Image	*temp_shared;	// New shared imag
...
voi
Fl_Shared_Image::color_average(Fl_Color c,	// I - Color to blend wit
