...
// Other label types (symbols) are in their own source file
...
static Fl_Label_Draw_F* table[MAX_LABELTYPE] = 
  ...
  fl_no_label, fl_no_label, fl_no_label
  fl_no_label, fl_no_label, fl_no_labe
}
...
// include these vars here so they can be referenced without includin
// Fl_Input_ code
