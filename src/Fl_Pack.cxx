...
// Based on code by Curtis Edward
// Group that compresses all it's children together and resizes to surroun
...
: Fl_Group(X, Y, W, H, l) 
  resizable(0)
  spacing_ = 0
  // type(VERTICAL); // already set like thi
...
void Fl_Pack::draw() 
  ...
  for (int i = children(); i--;) 
    ...
    if (o->visible()) 
      ...
      // Last child, if resizable, takes all remaining roo
