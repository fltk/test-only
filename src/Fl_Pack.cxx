//
// "$Id: Fl_Pack.cxx,v 1.17 2000/06/23 07:09:15 bill Exp $"
//
...
void Fl_Pack::draw() {
  int tx=x(); int ty=y(); int tw=w(); int th=h(); text_box()->inset(tx,ty,tw,th);
...
//
// End of "$Id: Fl_Pack.cxx,v 1.17 2000/06/23 07:09:15 bill Exp $".
//
