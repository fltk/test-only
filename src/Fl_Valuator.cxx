...
void Fl_Valuator::value_damage() {damage(FL_DAMAGE_EXPOSE);} // by default do partial-redra
...
void Fl_Valuator::handle_release() 
  if (when()&FL_WHEN_RELEASE) 
    // insure changed() is off even if no callback is done.  It may hav
    // been turned on by the drag, and then the slider returned to it'
    // initial position
    clear_changed()
...
int Fl_Valuator::format(char* buffer) 
  double v = value()
  // MRS: THIS IS A HACK - RECOMMEND ADDING BUFFER SIZE ARGUMEN
