...
// "$Id$
/
// More Xlib font utilities for the Fast Light Tool Kit (FLTK)
/
...
static int sort_function(const void *aa, const void *bb) 
  ...
  return name_a[0]-name_b[0]; // sort by attribut
...
// Suprisingly enough Xft works exactly like fltk does and return
...
int Fl::get_font_sizes(Fl_Font fnum, int*& sizep) 
  ...
  array[0] = 0; int j = 1; // claim all fonts are scalabl
