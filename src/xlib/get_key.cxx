...
// "$Id$
/
// Xlib keyboard state routines for the Fast Light Tool Kit (FLTK)
/
...
// Return the current state of a key.  This is the X version.  I identif
// keys (mostly) by the X keysym.  So this turns the keysym into a keycod
// and looks it up in the X key bit vector, which Fl_x.cxx keeps track of

#  include <FL/Fl.H
#  include <FL/x.H

extern char fl_key_vector[32]; // in Fl_x.cx
