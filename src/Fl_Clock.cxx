...
// Modifications by Mark Overmars for Form
// Further changes by Bill Spitzak for flt
...
void Fl_Clock_Output::draw(int X, int Y, int W, int H) 
  ...
  fl_pop_matrix()
  // draw the hands
  drawhands(selection_color(), FL_GRAY0); // color was 5
  fl_pop_matrix()
