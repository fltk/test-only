...
void Fl_Group::forms_end() 
  // set the dimensions of a group to surround content
  if (children() && !w()) 
...
void Fl_FormsText::draw() 
  draw_box()
  align(align()|FL_ALIGN_INSIDE); // questionable method of compatabilit
  draw_label()
