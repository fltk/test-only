...
// Implementation of fl_message, fl_ask, fl_choice, fl_inpu
// The three-message fl_show_x functions are for forms compatibilit
// mostly.  In most cases it is easier to get a multi-line messag
...
/
 * 'resizeform()' - Resize the form and widgets so that they hold everythin
