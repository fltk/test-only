...
// License along with this7 library; if not, write to the Free Softwar
...
enumcb(CONST LOGFONT    *lpelf
  ...
  for (int i=0; i<FL_FREE_FONT; i++) // skip if one of our built-in font
...
Fl_Font Fl::set_fonts(const char* xstarname) 
  if (fl_free_font == FL_FREE_FONT) {// if not already been calle
    if (!fl_gc) fl_GetDC(0)
