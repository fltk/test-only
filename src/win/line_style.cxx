...
void Fl_Win_Display::line_style(int style, int width, char* dashes) 
  ...
  // According to Bill, the "default" cap and join should be th
  // "fastest" mode supported for the platform.  I don't know wh
  // they should be different (same graphics cards, etc., right?) MR
  ...
  if (dashes && dashes[0]) 
    ...
    s1 |= style & 0xff; // allow them to pass any low 8 bits for styl
