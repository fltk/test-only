...
void fltk3::Choice::draw() {
  ...
  if (fltk3::scheme()) {
    ...
    if (fltk3::contrast(textcolor(), fltk3::BACKGROUND2_COLOR) == textcolor()) {
      fltk3::draw_box(DOWN_BOX, 0, 0, X, h(), fltk3::BACKGROUND2_COLOR, Box::TIE_RIGHT|Box::TIE_HIDDEN);
    } else {
      fltk3::draw_box(DOWN_BOX, 0, 0, X, h(), fltk3::lighter(color()), Box::TIE_RIGHT|Box::TIE_HIDDEN);
    }
