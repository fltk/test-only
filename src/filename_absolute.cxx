...
/* expand a file name by prepending current directory, deleting . an
   .. (not really correct for symbolic links) between the prepende
...
int					// O - 0 if no change, 1 if change
fl_filename_relative(char       *to,	// O - Relative filenam
                     int        tolen,	// I - Size of "to" buffe
                     const char *from) {// I - Absolute filenam
  const char	*newslash;		// Directory separato
  const char	*slash;			// Directory separato
  char		cwd[1024];		// Current director
