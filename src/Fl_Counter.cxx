//
// "$Id: Fl_Counter.cxx,v 1.36 2000/05/30 07:42:11 bill Exp $"
//
...
void Fl_Counter::draw() {
  ...
  text_box()->draw(xx[0], y(), ww[0], h(), text_background(), f);
...
//
// End of "$Id: Fl_Counter.cxx,v 1.36 2000/05/30 07:42:11 bill Exp $".
//
