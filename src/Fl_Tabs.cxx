...
// This is the "file card tabs" interface to allow you to put lots and lot
...
// return the left edges of each tab (plus a fake left edge for a ta
// past the right-hand one).  These position are actually of the lef
// edge of the slope.  They are either seperated by the correct distanc
...
// The value() is the first visible child (or the last child if non
// are visible) and this also hides any other children
// This allows the tabs to be deleted, moved to other groups, an
...
// Setting the value hides all other children, and makes this on
