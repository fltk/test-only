...
// There are a lot of subclasses, named Fl_*_Button.  Some o
// them are implemented by setting the type() value and testing i
// here.  This includes Fl_Radio_Button and Fl_Toggle_Butto
...
void Fl_Button::setonly() { // set this radio button on, turn others of
  value(1)
