...
static void draw_barchart(int x,int y,int w,int h
			  ...
			  Fl_Color textcolor
/* Draws a bar chart. x,y,w,h is the bounding box, entries the array o
...
static void draw_horbarchart(int x,int y,int w,int h
			     ...
			     double min, double max, int autosize, int maxnumb
			     Fl_Color textcolor
/* Draws a horizontal bar chart. x,y,w,h is the bounding box, entries th
...
static void draw_linechart(int type, int x,int y,int w,int h
			   ...
			   double min, double max, int autosize, int maxnumb
			   Fl_Color textcolor
/* Draws a line chart. x,y,w,h is the bounding box, entries the array o
   numb entries and min and max the boundaries. *
...
static void draw_piechart(int x,int y,int w,int h
			  ...
			  Fl_Color textcolor
/* Draws a pie chart. x,y,w,h is the bounding box, entries the array o
   numb entries *
...
void Fl_Chart::draw() 
    ...
    ww--; hh--; // adjust for line thicknes
...
#define FL_CHART_BOXTYPE	FL_BORDER_BO
#define FL_CHART_COL1		FL_COL
#define FL_CHART_LCOL		FL_LCO
#define FL_CHART_ALIGN		FL_ALIGN_BOTTO
