 ...
 * Emulates this call on systems that lack it (pretty much everythin
 ...
 * A malicious user who manages to create a %-fmt string that print
 * more than 99 characters can still overflow the temporary buffer
 * For instance %110f will overflow
 
 * Only handles formats that are both documented in the glibc man pag
