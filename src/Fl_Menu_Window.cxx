...
// which are used so that clicks outside the program's window
...
// WIN32 note: HAVE_OVERLAY is fals
#if HAVE_OVERLA
...
// Fix the colormap flashing on Maximum Impact Graphics by erasing th
