...
// This is much lighter than Fl_Value_Input because it has no text edito
// If step() is zero then it can be used to display a floating-point valu
...
: Fl_Valuator(X,Y,W,H,l) 
  ...
  textcolor_ = FL_FOREGROUND_COLOR; //was:FL_BLAC
  soft_ = 0
