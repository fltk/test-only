...
// Some releases of the Cygwin JPEG libraries don't have a correctl
// updated header file for the INT32 data type; the following defin
...
Fl_JPEG_Image::Fl_JPEG_Image(const char *jpeg)	// I - File to loa
  : Fl_RGB_Image(0,0,0) 
#ifdef HAVE_LIBJPE
  FILE				*fp;		// File pointe
  struct jpeg_decompress_struct	cinfo;		// Decompressor inf
  struct jpeg_error_mgr		jerr;		// Error handler inf
  JSAMPROW			row;		// Sample row pointe
