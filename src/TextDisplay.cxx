...
void TextDisplay::layout() {
    ...
    for (int again = 1; again;) {
        ...
        if (mContinuousWrap && !mWrapMargin && r.w()!=oldWidth) {
        ...
        if (scrollbar_width()) {
            ...
            if (scrollbar_align() & (ALIGN_LEFT|ALIGN_RIGHT) &&
                mNBufferLines >= mNVisibleLines - 1)
                {
                    ...
                    if (scrollbar_align() & ALIGN_LEFT) {
                        ...
                        mVScrollBar->resize(r.x(), text_area.y()-TOP_MARGIN, scrollbar_width(),
                                            text_area.h()+TOP_MARGIN+BOTTOM_MARGIN);
                    } else {
                        text_area.x(r.x()+LEFT_MARGIN);
                        text_area.w(r.w()-scrollbar_width()-LEFT_MARGIN-RIGHT_MARGIN);
                        mVScrollBar->resize(r.x()+r.w()-scrollbar_width(), text_area.y()-TOP_MARGIN,
            ...
            if (scrollbar_align() & (ALIGN_TOP|ALIGN_BOTTOM) &&
                (mVScrollBar->visible() || longest_vline() > text_area.w()))
                {
                    ...
                    if (scrollbar_align() & ALIGN_TOP) {
                        ...
                        mHScrollBar->resize(text_area.x()-LEFT_MARGIN, r.y(),
                                            text_area.w()+LEFT_MARGIN+RIGHT_MARGIN, scrollbar_width());
                    } else {
                        text_area.y(r.y()+TOP_MARGIN);
                        text_area.h(r.h()- scrollbar_width()-TOP_MARGIN-BOTTOM_MARGIN);
                        mHScrollBar->resize(text_area.x()-LEFT_MARGIN, r.y()+r.h()-scrollbar_width(),
                                            text_area.w()+LEFT_MARGIN+RIGHT_MARGIN, scrollbar_width());
                    }
                }
        }
